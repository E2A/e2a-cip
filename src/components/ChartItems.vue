<template>
  <div :class="base.wrapper">
    ...
    <!-- List of charts -->
    <BaseGutterWrapper :class="base.grid" el="ul">
      <li
      ...
      >
        <div :class="[border.top, border.secondary, space.paddingTop]">
          <Chart
            ...
            :series-data="chartData.seriesData[chartName]"
            :label-data="chartData.labelData[chartName]"
            :is-currency="chartData.isCurrency[chartName]"
            :tool-tip="$t(`chartToolTips.${chartName}`)"
          />
          <ResultsQuestions
